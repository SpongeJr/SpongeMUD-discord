module.exports = {
	...
	TICKS_PER_HOUR: 10,
	HOURS_IN_DAY: 24,
	TITLE_LIST: ["", "the Noob", "the Explorer", "the Adventurer", "the Experienced", "the Creative", "the Wizardly", "the Brave", "the Cowardly", "the Quester", "the Immortal", "the Janitor", "the Exterminator", "the Chess Master", "the Chef", "the Moderator"],
	POSTURE_STRINGS: {
