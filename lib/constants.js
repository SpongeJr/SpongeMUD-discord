module.exports = {
	DEBUG_LEVEL: 1,
	DEBUG_LEVEL_STRINGS: [
		"DEBUG0:", "DEBUG1:", "INFO:", " !!! WARNING:", "   ***** CRITICAL WARNING! ***** :"
	],
	ENTITIES: {
		"room": 0,
		"player": 1,
	...
	MUD: {
		...
		helpFile: 'spongemud/cmdhelp.json',
		droptableFile: 'spongemud/drops.json',
		mailPath: 'spongemud/mail/',
		backups: {
			...
			resourceFile: 'spongemud/bak/resources.json'
		}
	},
	DATA_DIR: '../data/',
	VERSION_STRING: '0.3.1-spearmint-000',
	SPONGEBOT_INFO: 'SpongeMUD (c) 2020 by Josh Kline',
	SPONGE_ID: "167711491078750208",
	MAINCHAN_ID: "402126095056633863",
	SPAMCHAN_ID: "402591405920223244",
	DEBUGCHAN_ID: "410435013813862401",
	NEWCHARCHAN_ID: "701711948982648874",
	MODERATORCHAN_ID: "701711948982648874",
	MODERATORPING_ROLEID: "575004230948225025",
	...
	START_ROOM: "Welcome to SpongeMUD!",
	PERM_LEVELS: {
		"player": "10",
		"wizard": "64",
		"immortal": "128",
	...
	PRIVACY_FLAG_DESC: {
		...
		"noShowServer": "Do not show my server (for instance, in leaderboards)",
		"acceptFriendMailOnly": "Accept mail only from friends"
	},
	PREFIX: 'm.',
	PLAYER_MACRO_LETTER: 'm',
	CFGFILE: 'spongemudcfg.json',
	SERVERCFGFILE: '../../servercfg.json',
	SETUP_COMMAND_PERM_FLAG: 32,
	COMMITTEES: {
		...
		"balance": {"emoji": ":scales:"},
		"crafting": {"emoji": ":wrench:"}
	},
	MONTHS: ['Archuary', 'Fooshuary', 'Keplembler', 'Bobtober', 'Kandy', 'Nicholaseptember', 'Ogtober', 'Ryvenber', 'Flonfuary', 'Squishuary'],
	TIME_OF_DAY_STRINGS: [
		{
			"endHour": 2,
	...
	TICKS_PER_HOUR: 10,
	HOURS_IN_DAY: 24,
	TITLE_LIST: ["", "the Noob", "the Explorer", "the Adventurer", "the Experienced", "the Creative", "the Wizardly", "the Brave", "the Cowardly", "the Quester", "the Immortal", "the Janitor", "the Exterminator", "the Chess Master", "the Chess Scholar", "the Chef", "the Moderator", "the Ensign", "the Voter"],
	POSTURE_STRINGS: {
