...
let Player = function(data, allRooms, allItems, allResources) {
...
Player.prototype.go = function(newLoc, client) {
...
Player.prototype.registerForRoomEvents = function() {
	...
	this.on('roomExit', (whoSaid, newRoom, client) => {
		// if whoSaid is a string, we do old-style stuff. For sit, stand, me, etc.
		//		this is for when players are the cause of the event
	...
	this.on('roomEnter', (whoSaid, lastRoom, client) => {
		// if whoSaid is a string, we do old-style stuff. For sit, stand, me, etc.
		//		this is for when players are the cause of the event
