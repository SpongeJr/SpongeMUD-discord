...
Item.prototype.whereIs = ut.defaultWhereIs;
...
Mob.prototype.whereIs = ut.defaultWhereIs;
...
BattleParticipant.prototype.handleDeath = function(battle) {
	...
	if (death) {
		...
		//} else if (this.participant.constructor === Player) {
			...
			//this.participant.die(battle.participants[this.lastAggressor].getName(), battles);
		//}
		this.leftBattle = true;
		return true;
	}
...
module.exports = {
  ...
  do: function(message, args) {
	...
	nukemyzone: {
		do: function(message, args) { // DONE: Remove client from this function
...
//-----------------------------------------------------------------------------
	...
	getfile: {
		do: function(message, args) { // DONE: remove client
			// args should be the name of one of the constants in constants.js
			let who = message.author.id;
